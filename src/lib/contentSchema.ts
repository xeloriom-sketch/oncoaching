...
export const PAGES: PageDef[] = [
  ...
  },
  {
    ...
    icon: "CreditCard",
    fields: [
      { key: "particuliers.title",              label: "Titre section Particuliers",        section: "Particuliers — Prix",  type: "short" },
      { key: "particuliers.subtitle",           label: "Sous-titre Particuliers",           section: "Particuliers — Prix",  type: "long"  },
      { key: "particuliers.cards.0.title",      label: "Coaching individuel — Titre",       section: "Particuliers — Prix",  type: "short" },
      { key: "particuliers.cards.0.items.0",    label: "Coaching individuel — Tarif 1",     section: "Particuliers — Prix",  type: "short" },
      { key: "particuliers.cards.0.items.1",    label: "Coaching individuel — Tarif 2",     section: "Particuliers — Prix",  type: "short" },
      { key: "particuliers.cards.1.title",      label: "Coaching parental — Titre",         section: "Particuliers — Prix",  type: "short" },
      { key: "particuliers.cards.1.items.0",    label: "Coaching parental — Tarif 1",       section: "Particuliers — Prix",  type: "short" },
      { key: "particuliers.cards.1.items.1",    label: "Coaching parental — Tarif 2",       section: "Particuliers — Prix",  type: "short" },
      { key: "particuliers.cards.2.title",      label: "Forfaits — Titre",                  section: "Particuliers — Prix",  type: "short" },
      { key: "particuliers.cards.2.items.0",    label: "Forfait scolaire — Tarif",          section: "Particuliers — Prix",  type: "short" },
      { key: "particuliers.cards.2.items.1",    label: "Forfait parentalité — Tarif",       section: "Particuliers — Prix",  type: "short" },
      { key: "entreprises.title",               label: "Entreprises — Titre section",       section: "Entreprises — Prix",   type: "short" },
      { key: "entreprises.subtitle",            label: "Entreprises — Sous-titre",          section: "Entreprises — Prix",   type: "long"  },
      { key: "entreprises.items.0",             label: "Entreprises — Tarif demi-journée",  section: "Entreprises — Prix",   type: "short" },
      { key: "entreprises.items.1",             label: "Entreprises — Tarif journée complète", section: "Entreprises — Prix", type: "short" },
      { key: "neurofeedback.title",             label: "Neurofeedback — Titre section",     section: "Neurofeedback — Prix", type: "short" },
      { key: "neurofeedback.subtitle",          label: "Neurofeedback — Sous-titre",        section: "Neurofeedback — Prix", type: "long"  },
      { key: "neurofeedback.cards.0.title",     label: "Séances individuelles — Titre",     section: "Neurofeedback — Prix", type: "short" },
      { key: "neurofeedback.cards.0.items.0",   label: "Séance 30 min",                     section: "Neurofeedback — Prix", type: "short" },
      { key: "neurofeedback.cards.0.items.1",   label: "Pack 5 séances",                    section: "Neurofeedback — Prix", type: "short" },
      { key: "neurofeedback.cards.0.items.2",   label: "Pack 10 séances",                   section: "Neurofeedback — Prix", type: "short" },
      { key: "neurofeedback.cards.1.title",     label: "Coaching + Neurofeedback — Titre",  section: "Neurofeedback — Prix", type: "short" },
      { key: "neurofeedback.cards.1.items.0",   label: "Séance combinée",                   section: "Neurofeedback — Prix", type: "short" },
      { key: "neurofeedback.cards.2.title",     label: "En entreprise — Titre",             section: "Neurofeedback — Prix", type: "short" },
      { key: "neurofeedback.cards.2.description", label: "En entreprise — Description",     section: "Neurofeedback — Prix", type: "long"  },
      { key: "neurofeedback.cards.2.note",      label: "En entreprise — Note tarif",        section: "Neurofeedback — Prix", type: "short" },
      { key: "faqItems",                        label: "FAQ tarifs (questions/réponses)",    section: "FAQ",                  type: "array" },
      { key: "steps",                           label: "Étapes processus",                  section: "Étapes",               type: "array" },
      { key: "cta.title",                       label: "Titre CTA",                         section: "Appel à l'action",     type: "short" },
      { key: "cta.buttonText",                  label: "Texte bouton",                      section: "Appel à l'action",     type: "short" },
    ],
  },
