        ...
        <section className="pt-20 md:pt-28 pb-12 md:pb-16 max-w-7xl mx-auto px-5 sm:px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              <h1
                id="equipe-h1"
                className="text-[clamp(2rem,6vw,5rem)] font-semibold tracking-tight text-[#1C3A52] leading-tight overflow-hidden"
              >
              ...
              >
                <E fieldKey="page.subtitle">{page.subtitle}</E> Transformer vos groupes de travail en équipes engagées, alignées et performantes pour une cohésion et une performance collective durables.
              </motion.p>
